...
NOTE: The XML file must have the same name as the executable, so the wrapper can discover it. Refer to the https://github.com/winsw/winsw/blob/v3/docs/xml-config-file.md[winsw configuration reference] for all available options.
