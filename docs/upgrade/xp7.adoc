= Upgrading from XP 7 to XP 8
:toc: right
:imagesdir: ../images

This guide covers migrating an Enonic XP 7 instance to XP 8. For upgrades between XP 8 releases, and the general upgrade procedure, see <<../upgrade#, Upgrading>>.
