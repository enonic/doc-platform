...
image:preview.svg[Preview,opts=inline] The engine that will replace Nashorn is here to try. GraalJS implements the current ECMAScript standard, well past Nashorn's ES5.
