...
In this case, a <<#configuration_file,vhost configuration>> looking like this will get the job done:
...
Visit the <<#configuration_file,vhost configuration>> section for more details.
